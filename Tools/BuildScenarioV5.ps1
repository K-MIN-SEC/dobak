...
$rows.Add((New-ScenarioRow "v5_d4_school_stable" "v5_d4_school_stable_02" "school" "4" "school" "school_complete" "counter.gamble_sessions<3" 210 "game" 2 "Seoyeon" "서연" "dialogue" "seoyeon_default" "내가 찾은 사례도 처음엔 보너스에 끌렸다가, 잃은 돈을 되찾으려고 돈까지 빌렸대. 집에 가서 이 사례랑 도움받는 방법을 정리하자."))
