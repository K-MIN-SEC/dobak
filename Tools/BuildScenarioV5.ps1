...
$rows.Add((New-ScenarioRow "v5_d2_start" "v5_d2_start_02" "main" "2" "7:00" "day_start" "" 220 "day" 2 "Protagonist" "나" "dialogue" "" "오늘 일하면 5만 원을 받는다. 수리비를 모으려면 늦지 않게 출발하자." -Effects "tutorial:set=map"))
