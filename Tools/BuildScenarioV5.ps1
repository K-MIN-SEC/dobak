...
$rows.Add((New-ScenarioRow "v5_d2_missed_daytime" "v5_d2_missed_daytime_01" "main" "2" "daytime" "job_missed" "schedule.job=missed;schedule.homework=pending" 175 "day" 1 "Protagonist" "나" "overlay" "" "점장님께 사과하고 늦은 아침을 먹었다. 알바 대신 밀린 집안일과 조별과제 자료를 정리하다 보니 어느새 16시가 됐다." -Effects "clock:advance_to=16:00" -Purpose "오전 결근 뒤 공부가 정오에 끝나 버리지 않도록 낮 시간을 자연스럽게 연결한다."))
...
$rows.Add((New-ScenarioRow "v5_d3_missed_daytime_first" "v5_d3_missed_daytime_first_01" "main" "3" "daytime" "job_missed" "schedule.job=missed;schedule.homework=pending;counter.job_failures=0" 176 "day" 1 "Protagonist" "나" "overlay" "" "점장님께 사과하고 다음 근무는 놓치지 않도록 일정을 다시 적었다. 점심을 먹고 발표 자료를 살펴보다 보니 16시가 됐다." -Effects "clock:advance_to=16:00" -Purpose "첫 결근 뒤 남은 낮 시간을 일정 정리와 과제 준비로 연결한다."))
$rows.Add((New-ScenarioRow "v5_d3_missed_daytime_fired" "v5_d3_missed_daytime_fired_01" "main" "3" "daytime" "job_missed" "schedule.job=missed;schedule.homework=pending;counter.job_failures>=1" 176 "day" 1 "Protagonist" "나" "overlay" "" "다음 근무를 잡기 어렵다는 메시지를 몇 번이나 다시 읽었다. 사라진 알바비와 수리비 계획을 다시 계산하다 보니 어느새 16시였다." -Effects "clock:advance_to=16:00" -Purpose "연속 결근의 해고 결과와 줄어든 수입을 낮 시간에 체감시킨다."))
...
$customReturnToTablet = @(
    "v5_d2_start", "v5_d2_job", "v5_d2_missed_daytime", "v5_d2_study_cue_done", "v5_d2_study_cue_missed", "v5_d2_study_done", "v5_d2_night_done", "v5_d2_night_missed",
    "v5_d3_start", "v5_d3_job_good", "v5_d3_job_return", "v5_d3_missed_daytime_first", "v5_d3_missed_daytime_fired", "v5_d3_case_cue_done", "v5_d3_case_cue_missed", "v5_d3_study_done", "v5_d3_night_done", "v5_d3_night_missed",
